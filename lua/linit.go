...
const (
	...
	LoadLibName = "package"
	// TabLibName is the key of the table Library.
	TabLibName = "table"
	// IoLibName is the key of the io Library.
	IoLibName = "io"
	// OsLibName is the key of the os Library.
	OsLibName = "os"
	// StringLibName is the key of the string Library.
	StringLibName = "string"
	// MathLibName is the key of the math Library.
	MathLibName = "math"
	// DebugLibName is the key of the debug Library.
	DebugLibName = "debug"
	// ChannelLibName is the key of the channel Library.
	ChannelLibName = "channel"
	// CoroutineLibName is the key of the coroutine Library.
