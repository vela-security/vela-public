...
////////////////////////////////////////////////////////
// This file was generated by go-private. DO NOT EDIT. //
////////////////////////////////////////////////////////
...
func mainLoop(L *LState, baseframe *callFrame) {
	...
	for {
		...
		cf.Pc++
		op = int(inst >> 26)
		if jumpTable[op](L, inst, baseframe, interceptorTable(op)) == 1 {
			return
		}
	}
}
...
func copyReturnValues(L *LState, regv, start, n, b int) { // +private-start
	if b == 1 {
		// this section is inlined by go-private
...
type instFunc func(*LState, uint32, *callFrame, interceptorFunc) int

var jumpTable [opCodeMax + 1]instFunc

func init() {
	jumpTable = [opCodeMax + 1]instFunc{
		func(L *LState, inst uint32, baseframe *callFrame, hook interceptorFunc) int { //OP_MOVE
		...
		func(L *LState, inst uint32, baseframe *callFrame, hook interceptorFunc) int { //OP_MOVEN
		...
		func(L *LState, inst uint32, baseframe *callFrame, hook interceptorFunc) int { //OP_LOADK
			if hook(L, inst, baseframe) {
				return 0
			}
		...
		func(L *LState, inst uint32, baseframe *callFrame, hook interceptorFunc) int { //OP_LOADBOOL
			if hook(L, inst, baseframe) {
				return 0
			}
		...
		func(L *LState, inst uint32, baseframe *callFrame, hook interceptorFunc) int { //OP_LOADNIL
			if hook(L, inst, baseframe) {
				return 0
			}
		...
		func(L *LState, inst uint32, baseframe *callFrame, hook interceptorFunc) int { //OP_GETUPVAL
			if hook(L, inst, baseframe) {
				return 0
			}
		...
		func(L *LState, inst uint32, baseframe *callFrame, hook interceptorFunc) int { //OP_GETGLOBAL
			if hook(L, inst, baseframe) {
				return 0
			}
		...
		func(L *LState, inst uint32, baseframe *callFrame, hook interceptorFunc) int { //OP_GETTABLE
			if hook(L, inst, baseframe) {
				return 0
			}
		...
		func(L *LState, inst uint32, baseframe *callFrame, hook interceptorFunc) int { //OP_GETTABLEKS
			if hook(L, inst, baseframe) {
				return 0
			}
			reg := L.reg
		...
		func(L *LState, inst uint32, baseframe *callFrame, hook interceptorFunc) int { //OP_SETGLOBAL
			if hook(L, inst, baseframe) {
				return 0
			}
		...
		func(L *LState, inst uint32, baseframe *callFrame, hook interceptorFunc) int { //OP_SETUPVAL
			if hook(L, inst, baseframe) {
				return 0
			}
		...
		func(L *LState, inst uint32, baseframe *callFrame, hook interceptorFunc) int { //OP_SETTABLE
			if hook(L, inst, baseframe) {
				return 0
			}
		...
		func(L *LState, inst uint32, baseframe *callFrame, hook interceptorFunc) int { //OP_SETTABLEKS
			if hook(L, inst, baseframe) {
				return 0
			}
		...
		func(L *LState, inst uint32, baseframe *callFrame, hook interceptorFunc) int { //OP_NEWTABLE
			if hook(L, inst, baseframe) {
				return 0
			}
		...
		func(L *LState, inst uint32, baseframe *callFrame, hook interceptorFunc) int { //OP_SELF
			if hook(L, inst, baseframe) {
				return 0
			}
		...
		opArith, // OP_MOD
		opArith, // OP_POW
		func(L *LState, inst uint32, baseframe *callFrame, hook interceptorFunc) int { //OP_UNM
			if hook(L, inst, baseframe) {
				return 0
			}
		...
		func(L *LState, inst uint32, baseframe *callFrame, hook interceptorFunc) int { //OP_NOT
			if hook(L, inst, baseframe) {
				return 0
			}
		...
		func(L *LState, inst uint32, baseframe *callFrame, hook interceptorFunc) int { //OP_LEN
			if hook(L, inst, baseframe) {
				return 0
			}
			...
			case *AnyData:
				reg.SetNumber(RA, LNumber(lv.Len(L)))
			default:
		...
		func(L *LState, inst uint32, baseframe *callFrame, hook interceptorFunc) int { //OP_CONCAT
			if hook(L, inst, baseframe) {
				return 0
			}
		...
		func(L *LState, inst uint32, baseframe *callFrame, hook interceptorFunc) int { //OP_JMP
			if hook(L, inst, baseframe) {
				return 0
			}
		...
		func(L *LState, inst uint32, baseframe *callFrame, hook interceptorFunc) int { //OP_EQ
			if hook(L, inst, baseframe) {
				return 0
			}
		...
		func(L *LState, inst uint32, baseframe *callFrame, hook interceptorFunc) int { //OP_LT
			if hook(L, inst, baseframe) {
				return 0
			}
		...
		func(L *LState, inst uint32, baseframe *callFrame, hook interceptorFunc) int { //OP_LE
			if hook(L, inst, baseframe) {
				return 0
			}
		...
		func(L *LState, inst uint32, baseframe *callFrame, hook interceptorFunc) int { //OP_TEST
			if hook(L, inst, baseframe) {
				return 0
			}
		...
		func(L *LState, inst uint32, baseframe *callFrame, hook interceptorFunc) int { //OP_TESTSET
			if hook(L, inst, baseframe) {
				return 0
			}
		...
		func(L *LState, inst uint32, baseframe *callFrame, hook interceptorFunc) int { //OP_CALL
			if hook(L, inst, baseframe) {
				return 0
			}
			...
			//for i:=1 ;i<=nargs;i++ {
			//	fmt.Printf("reg.top:%d , reg:%d = %v , top-%d = %v\n" , top , RA , reg.GetCodeVM(RA + i) , i -1 , reg.GetCodeVM(top - i + 1))
			//}
			//直接运行
			...
			if fn, ok := lv.AssertFunction(); ok {
				...
				callable, meta = L.metaCall(lv.Peek())
			}

			// this section is inlined by go-private
			// source function is 'func (ls *LState) pushCallFrame(cf callFrame, fn LValue, metaFunc bool) ' in '_state.go'
			{
				ls := L
		...
		func(L *LState, inst uint32, baseframe *callFrame, hook interceptorFunc) int { //OP_TAILCALL
			if hook(L, inst, baseframe) {
				return 0
			}
		...
		func(L *LState, inst uint32, baseframe *callFrame, hook interceptorFunc) int { //OP_RETURN
			if hook(L, inst, baseframe) {
				return 0
			}
		...
		func(L *LState, inst uint32, baseframe *callFrame, hook interceptorFunc) int { //OP_FORLOOP
			if hook(L, inst, baseframe) {
				return 0
			}
		...
		func(L *LState, inst uint32, baseframe *callFrame, hook interceptorFunc) int { //OP_FORPREP
			if hook(L, inst, baseframe) {
				return 0
			}
		...
		func(L *LState, inst uint32, baseframe *callFrame, hook interceptorFunc) int { //OP_TFORLOOP
			if hook(L, inst, baseframe) {
				return 0
			}
		...
		func(L *LState, inst uint32, baseframe *callFrame, hook interceptorFunc) int { //OP_SETLIST
			if hook(L, inst, baseframe) {
				return 0
			}
		...
		func(L *LState, inst uint32, baseframe *callFrame, hook interceptorFunc) int { //OP_CLOSE
			if hook(L, inst, baseframe) {
				return 0
			}
		...
		func(L *LState, inst uint32, baseframe *callFrame, hook interceptorFunc) int { //OP_CLOSURE
			if hook(L, inst, baseframe) {
				return 0
			}
		...
		func(L *LState, inst uint32, baseframe *callFrame, hook interceptorFunc) int { //OP_VARARG
			if hook(L, inst, baseframe) {
				return 0
			}
		...
		func(L *LState, inst uint32, baseframe *callFrame, hook interceptorFunc) int { //OP_NOP
			if hook(L, inst, baseframe) {
				return 0
			}
...
func opArith(L *LState, inst uint32, baseframe *callFrame, hook interceptorFunc) int { //OP_ADD, OP_SUB, OP_MUL, OP_DIV, OP_MOD, OP_POW
	if hook(L, inst, baseframe) {
		return 0
	}
	...
	B := int(inst & 0x1ff)    //GETB
	C := int(inst>>9) & 0x1ff //GETC
	lhs := L.rkValue(B).Peek()
	rhs := L.rkValue(C).Peek()
...
func equals(L *LState, lhs, rhs LValue, raw bool) bool {
	...
	if lt == LTInt && rt == LTNumber {
		return int(lhs.Peek().(LInt)) == int(rhs.Peek().(LNumber))
	}

	if lt == LTNumber && rt == LTInt {
		return int(lhs.Peek().(LNumber)) == int(rhs.Peek().(LInt))
	}
